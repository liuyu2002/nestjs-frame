import { IPayCreateReq } from "../common/IPayCreate"


// https://api.mch.weixin.qq.com/v3/pay/transactions/native
export const PathPayCreate = 'pay/transactions/jsapi'
...
export interface IPayCreateJsApiReq extends IPayCreateReq {
    payer: {
        openid: string
    }
}

export interface IPayCreateRes { prepay_id: string }